...
(resnet文件; 无监督预训练pth转ckpt，用于无监督预训练脚本中的评估)
"""
import argparse
...
#python pthtockpt0.py --pth_path /old/fyy/mocov2/torch_premodel/moco_v1_200ep_pretrain.pth.tar --ckpt_path /old/fyy/mocov2/mscode/pthtockpt_model/moco_v1_200ep_pretrain_moco.ckpt
