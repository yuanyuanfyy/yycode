...
if __name__ == '__main__':
    ...
    #param_dict2 = mindspore.load_checkpoint(args_opt.ckpt_path)
    #print(param_dict2)
...
#python pthtockpt.py --pth_path /old/fyy/mocov2/torch_premodel/moco_v1_200ep_pretrain.pth.tar --ckpt_path /old/fyy/mocov2/mscode/pthtockpt_model/moco_v1_200ep_pretrain.ckpt
#python pthtockpt.py --pth_path /old/fyy/mocov2/torch_premodel/moco_v1_200ep_best.pth.tar --ckpt_path /old/fyy/mocov2/mscode/pthtockpt_model/moco_v1_200ep_best.ckpt
#python pthtockpt.py --pth_path /old/fyy/mocov2/torch_premodel/resnet50-19c8e357.pth --ckpt_path /old/fyy/mocov2/mscode/pthtockpt_model/resnet50-19c8e357.ckpt
